class ProductsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @product.save
        format.html { redirect_to product_path(@product), :notice => @controller_name +t(:message_success_insert)  }
  ...
  def update
    respond_to do |format|
      if @product.update_attributes(product_params)
        format.html { redirect_to product_path(@product), :notice =>@controller_name +t(:message_success_update) }
