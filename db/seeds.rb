...
GeneCategory.create(:id=>12,:title=>'카페인대사',:sub_title=>'caffeine',:enable=>true,:tip=>'햇빛이 강한날에 야외활동을 오래한다면 누구나 피부에 색소침착이 생길 수 있으나')

Gene.create(:id=>1,:title=>'색소 형성 단백질 생산',:sub_title=>'OCA2',:description=>'피부의 색소 침착 정도가 평균보다 높아질 수 있습니다.',:enable=>true)
Gene.create(:id=>2,:title=>'피부 색소침착',:sub_title=>'MC1R',:description=>'유멜라닌의 생성능이 감소되고 페오멜라닌 생성이 높아져 햇빛에 대한 보호능력이 떨어질 수 있습니다.',:enable=>true)
Gene.create(:id=>3,:title=>'인슐린 분비능',:sub_title=>'CDKN2A/2B',:description=>'인슐린 분비능이 상대적으로 떨어질 수 있습니다.',:enable=>true)
Gene.create(:id=>4,:title=>'공복시 형당치의 상승',:sub_title=>'G6PC2',:description=>'인슐린의 분비가 상대적으로 감소되어 혈당이 상승할 수 있습니다.',:enable=>true)
Gene.create(:id=>5,:title=>'체내 인슐린 분비',:sub_title=>'G6PC2',:description=>'체내 인슐린분비가 상대적으로 떨어져 혈당수치가 높아질 수 있습니다.',:enable=>true)
Gene.create(:id=>6,:title=>'혈당 수치',:sub_title=>'DGKB-TMEM195',:description=>'인슐린의 반응성이 상대적으로 떨어져 혈당수치가 높아질 수 있습니다.',:enable=>true)

GeneRelation.create(:id=>1,:enable=>true,:title=>'멜라닌 생성에 주요 역할')
GeneRelation.create(:id=>2,:enable=>true,:title=>'피부의 색소침착에 관여')
GeneRelation.create(:id=>3,:enable=>true,:title=>'모발생상 관여')
GeneRelation.create(:id=>4,:enable=>true,:title=>'피부색 관여 ')
GeneRelation.create(:id=>5,:enable=>true,:title=>'점의 수 관여')
GeneRelation.create(:id=>6,:enable=>true,:title=>'주근깨 관여')
GeneRelation.create(:id=>7,:enable=>true,:title=>'인종간 눈의 색상에 관여')
GeneRelation.create(:id=>8,:enable=>true,:title=>'멜라닌 전자기전 조절에 관여')
GeneRelation.create(:id=>9,:enable=>true,:title=>'멜라닌붑비 관여')
GeneRelation.create(:id=>10,:enable=>true,:title=>'피부색 관여')
GeneRelation.create(:id=>11,:enable=>true,:title=>'모발색상 관여')
GeneRelation.create(:id=>12,:enable=>true,:title=>'인슐린 분비감소 관여')
GeneRelation.create(:id=>13,:enable=>true,:title=>'포도당 농도 증가 관여')
GeneRelation.create(:id=>14,:enable=>true,:title=>'당뇨병 연관')
GeneRelation.create(:id=>15,:enable=>true,:title=>'췌장 베타세포')
GeneRelation.create(:id=>16,:enable=>true,:title=>'인슐린생산에 관여')
GeneRelation.create(:id=>17,:enable=>true,:title=>'인슐린 반응성 감소 관여')

GeneCategoriesGene.create(:gene_category_id=>1,:gene_id=>1)
GeneCategoriesGene.create(:gene_category_id=>1,:gene_id=>2)
GeneCategoriesGene.create(:gene_category_id=>2,:gene_id=>3)
GeneCategoriesGene.create(:gene_category_id=>2,:gene_id=>4)

GenesGeneRelation.create(:gene_id=>1,:gene_relation_id=>1)
GenesGeneRelation.create(:gene_id=>1,:gene_relation_id=>2)
GenesGeneRelation.create(:gene_id=>1,:gene_relation_id=>3)
GenesGeneRelation.create(:gene_id=>1,:gene_relation_id=>4)
GenesGeneRelation.create(:gene_id=>1,:gene_relation_id=>5)
GenesGeneRelation.create(:gene_id=>1,:gene_relation_id=>6)
GenesGeneRelation.create(:gene_id=>1,:gene_relation_id=>7)
GenesGeneRelation.create(:gene_id=>2,:gene_relation_id=>8)
GenesGeneRelation.create(:gene_id=>2,:gene_relation_id=>9)
GenesGeneRelation.create(:gene_id=>2,:gene_relation_id=>10)
GenesGeneRelation.create(:gene_id=>2,:gene_relation_id=>11)
GenesGeneRelation.create(:gene_id=>3,:gene_relation_id=>12)
GenesGeneRelation.create(:gene_id=>3,:gene_relation_id=>13)
GenesGeneRelation.create(:gene_id=>4,:gene_relation_id=>12)
GenesGeneRelation.create(:gene_id=>4,:gene_relation_id=>13)
GenesGeneRelation.create(:gene_id=>5,:gene_relation_id=>14)
GenesGeneRelation.create(:gene_id=>5,:gene_relation_id=>15)
GenesGeneRelation.create(:gene_id=>6,:gene_relation_id=>17)
GenesGeneRelation.create(:gene_id=>6,:gene_relation_id=>14)

Report.create(:order_id=>1,:report_category_id=>1,:gene_category_id=>1,:enable=>true)
Report.create(:order_id=>1,:report_category_id=>1,:gene_category_id=>2,:enable=>true)
Report.create(:order_id=>1,:report_category_id=>1,:gene_category_id=>3,:enable=>true)

Report.create(:order_id=>1,:report_category_id=>2,:gene_category_id=>4,:enable=>true)
Report.create(:order_id=>1,:report_category_id=>2,:gene_category_id=>5,:enable=>true)
Report.create(:order_id=>1,:report_category_id=>2,:gene_category_id=>6,:enable=>true)

Report.create(:order_id=>1,:report_category_id=>3,:gene_category_id=>7,:enable=>true)
Report.create(:order_id=>1,:report_category_id=>3,:gene_category_id=>8,:enable=>true)
Report.create(:order_id=>1,:report_category_id=>3,:gene_category_id=>9,:enable=>true)
Report.create(:order_id=>1,:report_category_id=>3,:gene_category_id=>10,:enable=>true)
Report.create(:order_id=>1,:report_category_id=>3,:gene_category_id=>11,:enable=>true)
