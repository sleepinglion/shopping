...
Product.create(:title=>'product1',:description=>'Good Propduct1',:price=>150001,:shipping_price=>3000,:enable=>true)
Product.create(:title=>'product2',:description=>'Good Propduct2',:price=>150002,:shipping_price=>3000,:enable=>true)
Product.create(:title=>'product3',:description=>'Good Propduct3',:price=>150003,:shipping_price=>3000,:enable=>true)
Product.create(:title=>'product4',:description=>'Good Propduct4',:price=>150004,:shipping_price=>3000,:enable=>true)
Product.create(:title=>'product5',:description=>'Good Propduct5',:price=>150005,:shipping_price=>3000,:enable=>true)
Product.create(:title=>'product6',:description=>'Good Propduct6',:price=>150006,:shipping_price=>3000,:enable=>true)
Product.create(:title=>'product7',:description=>'Good Propduct7',:price=>150007,:shipping_price=>3000,:enable=>true)
Product.create(:title=>'product8',:description=>'Good Propduct8',:price=>150008,:shipping_price=>3000,:enable=>true)
Product.create(:title=>'product9',:description=>'Good Propduct9',:price=>150009,:shipping_price=>3000,:enable=>true)
Product.create(:title=>'product10',:description=>'Good Propduct10',:price=>150010,:shipping_price=>3000,:enable=>true)
Product.create(:title=>'product11',:description=>'Good Propduct11',:price=>150011,:shipping_price=>3000,:enable=>true)
Product.create(:title=>'product12',:description=>'Good Propduct12',:price=>150012,:shipping_price=>3000,:enable=>true)
